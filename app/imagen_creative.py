...
def generate_and_show_images(
    ...
    try:
        ...
        logging.info(
            f"🎉 All {len(response.generated_images)} image(s) should now be open in your image viewer."
        )
...
if __name__ == "__main__":
    ...
    brandbook_bol = (
        "Use colors of the images, modern and sleek design, minimalistic style, text in bold Arial font. "
